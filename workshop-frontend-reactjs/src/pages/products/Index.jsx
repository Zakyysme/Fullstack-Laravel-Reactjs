            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  className={`block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ${formik.touched.nama && formik.errors.nama ? 'ring-red-500' : 'ring-gray-300'
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  className={`block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ${formik.touched.deskripsi && formik.errors.deskripsi ? 'ring-red-500' : 'ring-gray-300'
                    } placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600 sm:text-sm`}
                />
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  className={`block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ${formik.touched.harga && formik.errors.harga ? 'ring-red-500' : 'ring-gray-300'
                    } placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600 sm:text-sm`}
                />
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  className={`block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ${formik.touched.stock && formik.errors.stock ? 'ring-red-500' : 'ring-gray-300'
                    } placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600 sm:text-sm`}
                />
